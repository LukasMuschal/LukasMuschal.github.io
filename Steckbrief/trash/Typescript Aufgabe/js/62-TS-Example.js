...
let playerItems = "Schwert der Macht"; // Da es nur einen Spieler gibt, ergibt sich noch nicht viel Sinn darin, für den Spieler ein interface (im Sinne der Programmierung) zu erstellen.
// Mehrere Arrays, welche jeweils Bauteile für Namen oder Eigenschaften der Monster beinhalten. lol
let prefix = ["Wütendes", "Fettes", "Gesandter", "Kreischendes", "Wütendes", "Zerberstender",]; // length = 6, da 6 Einträge. Von 0-5.
let monsterName = ["Scheusal", "Würmchen", "Todbringer", "Mistvieh", "Kampfkatze", "Affe",]; // length = 6, da 6 Einträge. Von 0-5.
let suffix = [" der Boshaft", " des Todes", " aus der Hölle", " Der Unterwelt", "Wächter der Deppen", " des Verderbens",]; // length = 6, da hier 6 Einträge sind. Von 0-5.
